...
const routes = [
  ...
  { path: "/enterprise/workflows", component: () => import("../pages/enterprise/workflows/index.vue") },
  { path: "/enterprise/workflows/:id", component: () => import("../pages/enterprise/workflows/index.vue") },
  ...
  { path: "/enterprise/inquiry", component: () => import("../pages/enterprise/inquiry/index.vue") },
  { path: "/enterprise/inquiry/history", component: () => import("../pages/enterprise/inquiry/history/index.vue") },
  ...
  { path: "/enterprise/billing", component: () => import("../pages/enterprise/billing/index.vue") },
  { path: "/enterprise/energy-center", component: () => import("../pages/enterprise/energy-center/index.vue") },
